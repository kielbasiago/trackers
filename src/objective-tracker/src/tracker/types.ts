...
export type QUsb2SnesOperandRequest<TOpcode extends string> = QUsb2SnesRequest<TOpcode> & {
...
export type ConnectionStatus = 'NeedsConnection' | 'Connecting' | 'Connected' | 'Disconnected' | 'Attaching' | 'Attached';

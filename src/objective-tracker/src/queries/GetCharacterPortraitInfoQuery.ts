...
export type CharacterPortraitInfoResponse = {
    portraits: Record<FF6Character, Character>;
};
export class GetCharacterPortraitInfoQuery extends Query<CharacterPortraitInfoResponse> {
    ...
    public async onResponse(responses: Array<Buffer>): Promise<CharacterPortraitInfoResponse> {
